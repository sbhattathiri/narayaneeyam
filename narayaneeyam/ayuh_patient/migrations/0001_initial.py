    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_type', models.CharField(blank=True, choices=[('O +ve', 'O_POS'), ('O -ve', 'O_NEG'), ('A +ve', 'A_POS'), ('A -ve', 'A_NEG'), ('B +ve', 'B_POS'), ('B -ve', 'B_NEG'), ('AB +ve', 'AB_POS'), ('AB -ve', 'AB_NEG')], default='', null=True)),
